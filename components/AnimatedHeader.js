...
import { Menu, X, ChevronLeft, ChevronRight, Home, Info, Briefcase, Phone, Star } from 'lucide-react';
    ...
    <header className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="relative h-[calc(100vh-80px)]">
        ...
        <div className="relative h-full overflow-hidden">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-6 top-1/2 transform -translate-y-1/2 z-20 p-3 text-white/80 hover:text-white transition-colors duration-300"
          >
            <div className="relative">
          ...
          <button
            onClick={nextSlide}
            className="absolute right-6 top-1/2 transform -translate-y-1/2 z-20 p-3 text-white/80 hover:text-white transition-colors duration-300"
          >
            <div className="relative">
